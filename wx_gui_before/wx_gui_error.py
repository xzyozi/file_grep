...
class FindTextGUI(wx.Frame):
    ...
    def init_window_main(self):
        ...
        read_folder_btn = wx.Button(self.panel, label="Read Folder")
        exit_btn = wx.Button(self.panel, label="Exit")
        self.Bind(wx.EVT_BUTTON, self.on_read_folder, read_folder_btn)
        self.Bind(wx.EVT_BUTTON, self.on_close, exit_btn)

        vbox.Add(hbox1, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.TOP, border=10)
        vbox.Add(hbox2, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.TOP, border=10)
        vbox.Add(hbox3, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.TOP, border=10)
        vbox.Add(read_folder_btn, flag=wx.ALIGN_CENTER | wx.TOP | wx.BOTTOM, border=10)
        vbox.Add(exit_btn, flag=wx.ALIGN_CENTER | wx.BOTTOM, border=10)
