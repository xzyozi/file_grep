...
class FindTextGUI(wx.Frame):
    def __init__(self):
        ...
        # Create a context menu for right-click actions in Japanese (JP).
        self.right_click_menu_jp = wx.Menu()
        self.right_click_menu_jp.Append(wx.ID_COPY, "コピー")  # Add a "Copy" menu item.
        self.right_click_menu_jp.Append(wx.ID_PASTE, "貼り付け")  # Add a "Paste" menu item.
